...
public class PortActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnvoltar=(Button) findViewById(R.id.btnVoltarP); // instanciando o objeto para ativação do botão
		...
		TextView txtresu=(TextView) findViewById(R.id.txtexibe); // instanciação do objeto que exibirá a frase
